class MyRoutes {
  ...
  static String paymentAndOrderHistoryRoute = "/paymentAndOrderHistory";
  static String myCertificatesRoute = "/myCertificates";
  static String termsAndConditionsRoute = "/termsAndConditions";
